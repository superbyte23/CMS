...
<div class="container-fluid">
  <!-- Page title -->
  <div class=" card card-body page-header d-print-none shadow">
  ...
  <div class="d-flex align-items-center justify-content-between">
    ...
    <div class="col d-none d-lg-block">
      <h1 class="display-6 text-center mb-0 program-title "><?php echo  ucwords(strtolower($program_info->program_name)) ?></h1>
    </div>
